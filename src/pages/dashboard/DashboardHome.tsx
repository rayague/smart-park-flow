...
import { ArrowRight, Battery, Car, Clock, Leaf, MapPin, TrendingUp } from 'lucide-react';
    ...
    <>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        >
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  {parking.hasEV && (
                    <div className="h-6 w-6 rounded-full bg-secondary/20 flex items-center justify-center">
                      <Battery className="h-3 w-3 text-secondary" />
                    </div>
                  )}
                </div>
          ...
          <Button className="w-full mt-4 gradient-primary text-primary-foreground border-0">Find More Spots</Button>
        </motion.div>
      </div>
    </>
  );
