      ...
      <div className="container mx-auto px-4">
        <div className="relative overflow-hidden rounded-3xl glass-strong p-6 md:p-10">
          ...
          <div className="relative">
            <h1 className="font-display text-3xl md:text-5xl font-bold gradient-text mb-3">Help</h1>
            <p className="text-muted-foreground max-w-2xl">Centre d’aide, FAQ et guides d’utilisation.</p>
          </div>
        </div>
      </div>
    </main>
