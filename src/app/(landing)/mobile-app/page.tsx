      ...
      <div className="container mx-auto px-4">
        <div className="relative overflow-hidden rounded-3xl glass-strong p-6 md:p-10">
          ...
          <div className="relative">
            <h1 className="font-display text-3xl md:text-5xl font-bold gradient-text mb-3">Mobile App</h1>
            <p className="text-muted-foreground max-w-2xl">
              L’app arrive bientôt. Notifications, guidage, wallet, et accès instantané.
            </p>
          </div>
        </div>
      </div>
